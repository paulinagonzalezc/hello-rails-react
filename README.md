...
```sh
  cd my-folder
  git clone  https://github.com/paulinagonzalezc/hello-rails-react
```
...
Feel free to check the [issues page](https://github.com/paulinagonzalezc/hello-rails-react/issues).
